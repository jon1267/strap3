...
<div style="padding-top:30px;padding-bottom:30px;margin-left:20px;">
  ...
  <b><i>Список товаров</i></b> <!-- <a href="/tovar/add">Добавить товар</a> --><br>
  <br>
  ...
  <?php while($row = mysqli_fetch_assoc($tovars)) { ?>
	<div>
	  ...
	  <a href="/tovar/edit/?id=<?php echo $row['id']; ?>">Редактир</a>&nbsp
	  <!-- <a href="/tovar/main/?action=delete&id=<?php echo $row['id']; ?>">Удалить</a>&nbsp  -->
