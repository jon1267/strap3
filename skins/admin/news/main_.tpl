<!-- Самый начальный код вывод новости в строку, выводися заголовок и дата новости -->
<div style="padding-top:30px;padding-bottom:30px;margin-left:20px;">
<?php if(isset($info)) { ?>
  <h3><?php echo $info; ?></h3>
<?php } ?>
<b>Все новости:</b>&nbsp&nbsp <a href="/admin/news/add">Добавить новость</a><br><br>
...
<!-- style="padding-top:30px;padding-bottom:30px;margin-left:20px;" -->
	<div>
	  <div>
		...
		<a href="/admin/news/edit?id=<?php echo $row['id']; ?>">Редактир</a> &nbsp;
